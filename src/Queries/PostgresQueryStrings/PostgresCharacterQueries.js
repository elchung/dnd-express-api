...
exports.getCharacterNamesByUserIdQuery = exports.getCharacterByIdQuery = void 0;
exports.getCharacterByIdQuery = "select " +
    "json_build_object( " +
    ...
    "hit_die.id, " +
    "settings.id;";
exports.getCharacterNamesByUserIdQuery = "SELECT " +
    "json_agg( " +
    "json_build_object( " +
